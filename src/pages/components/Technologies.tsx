const Technologies = () => {
  return (
    <section className="technologies mx-10 flex flex-col gap-6 rounded-2xl bg-white py-12">
      <section className="technology-row flex  w-full justify-evenly">
        <svg
          className="w-[50px] fill-secondary "
      ...
      <section className="technology-row flex w-full justify-evenly"></section>
      <section className="technology-row flex w-full justify-evenly"></section>
    </section>
  );
};
