...
const Organizations = () => {
  ...
  return (
    <section className="flex flex-col gap-12">
      {" "}
      <h1 className=" dark:text-primaryLight   col-span-7 flex flex-col gap-8   font-heading text-5xl font-bold  text-secondary lg:pb-12 lg:text-6xl">
        Volunteer Work
      </h1>
      <section className=" relative  overflow-x-hidden rounded-xl ">
        <section
          className={` ${getCurrentOrg(
            currentOrg
          )}  lg:bg-primaryLight grid w-[300%] max-w-[300%] grid-cols-3  gap-4 bg-primary p-2 transition-transform duration-[500ms] dark:bg-primary md:max-w-full`}
        >
          <OrganizationCard
