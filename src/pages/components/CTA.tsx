const CTA = () => {
  return (
    <section className="   z-10 col-span-2 flex  bg-primaryLight   font-semibold  dark:bg-secondary  lg:justify-end ">
      <section className="cta    justify-evenly gap-4 py-4 lg:flex lg:justify-start lg:justify-items-start lg:align-top">
        <a
          href="#_"
          className="group relative inline-block text-lg  text-white   lg:text-center"
        >
